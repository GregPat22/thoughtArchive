...
// Temporarily unused: kept in codebase for quick re-enable.
export function ContactsCard({ variants }: ContactsCardProps) {
  return (
    <motion.div
      variants={variants}
      className="order-4 group relative flex flex-col justify-between overflow-hidden border border-foreground/10 bg-foreground/3 p-6 transition-colors hover:border-[#ffe066]/50 hover:bg-foreground/6 md:order-0 md:col-span-3 md:row-span-2 md:p-8"
    >
      <div>
        <AtSign
